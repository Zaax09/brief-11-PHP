...
<table  style=" margin-top:50px;" border="-1" id="table">
    <thead class="table">
        <tr >
            ...
            <td > <span> Nouvel index :</span> <?php echo $index2  ?></td>
    ...
    <tbody>
        ...
        echo "<tr><th  colspan='3' class='th'>CONSOMMATION ELECTRICITE</th><th  colspan='4' class='th' style='text-align:right;'>إستھلاك الكھرباء </th></tr>";
            if($cons <= 150){
                if($cons <= 100){
...
<button  style= "margin-left:40%" type="print" id="print" class="p-3 mb-2 bg-warning text-dark w-25 d-inline-block"  >Print</button>
<script >
